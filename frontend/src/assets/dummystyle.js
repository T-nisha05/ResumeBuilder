export const landingPageStyles = {
  ...
  heroGrid: "grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center",
  heroLeft: "max-w-4xl",
  tagline:
  ...
  headingGradient:
    "block bg-gradient-to-r from-violet-600 via-fuchsia-600 to-orange-500 bg-clip-text text-transparent break-keep",
  description:
  ...
  // Buttons
  primaryButton:
    "group relative px-10 py-4 rounded-xl font-semibold text-white text-lg overflow-hidden bg-gradient-to-r from-violet-600 via-fuchsia-500 to-pink-500 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-pink-200",
  primaryButtonOverlay:
    "absolute inset-0 bg-gradient-to-r from-pink-500 to-orange-500 opacity-0 group-hover:opacity-100 transition-all duration-500",
  primaryButtonContent: "relative z-10 flex items-center gap-2",
  primaryButtonIcon:
    "transition-transform duration-300 group-hover:translate-x-1",
  secondaryButton:
    "px-10 py-4 rounded-2xl border border-violet-300 text-violet-700 font-semibold text-lg bg-white shadow-[0_0_0_1px_rgba(139,92,246,0.15)] transition-all duration-300 hover:bg-violet-50 hover:shadow-lg hover:scale-105",

  // Stats
  statsContainer: "flex gap-8 mt-8 justify-center flex-wrap",
  ...
  ctaCard: "relative",
  ctaCardBg:
    "absolute -inset-4 sm:-inset-6 bg-gradient-to-r from-violet-200/30 to-fuchsia-200/30 rounded-3xl blur-2xl",
  ctaCardContent:
    "relative bg-gradient-to-br from-white to-violet-50 border border-violet-100 rounded-3xl p-10 sm:p-16 text-center max-w-4xl mx-auto",
  ctaTitle:
    "text-3xl sm:text-4xl lg:text-5xl font-extrabold text-slate-900 mb-4 sm:mb-6",
  ctaTitleGradient:
    "bg-gradient-to-r from-violet-600 to-fuchsia-600 bg-clip-text text-transparent",
  ctaDescription:
    "text-lg sm:text-xl text-slate-800 mb-8 w-max mx-auto whitespace-nowrap sm:whitespace-normal",
  ctaButton:
    "group relative px-8 sm:px-12 py-4 bg-gradient-to-r from-fuchsia-500 to-orange-500 text-white font-semibold text-lg rounded-xl overflow-hidden transition-all hover:scale-105 hover:shadow-xl",
  ctaButtonOverlay:
    "absolute inset-0 rounded-xl bg-gradient-to-r from-violet-600 to-fuchsia-600 opacity-0 group-hover:opacity-100 transition",
...
export const inputStyles = {
  ...
  inputContainer: (isFocused) =>
    `flex items-center w-full rounded-xl border px-4 py-3 transition-all duration-200
   ${
     isFocused
       ? "border-violet-500 shadow-[0_0_0_4px_rgba(139,92,246,0.25)]"
       : "border-gray-300"
   }`,
  inputField:
    "w-full bg-transparent outline-none border-none text-gray-800 placeholder-gray-500 font-medium",
};
