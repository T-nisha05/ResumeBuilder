...
import { ArrowBigRight, LayoutTemplate, Menu, X, Zap, Download } from "lucide-react";
        ...
        <section className={landingPageStyles.heroSection}>
          <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
            <div className={landingPageStyles.heroGrid}>
              {/* LEFT CONTENT */}
              <div
                className={`${landingPageStyles.heroLeft} space-y-6 sm:space-y-8`}
              >
                ...
                <p className={landingPageStyles.description}>
                  Create job-winning resumes with expertely design templates.
                  ATS-friendly, recruiter-approved and tailored to your career
                  goals.
                </p>

                <div className={landingPageStyles.ctaButtonsContainer}>
                  {/* PRIMARY */}
                  <button
          ...
          <div className={landingPageStyles.featuresContainer}>
            ...
            <div className={landingPageStyles.featuresGrid}>
              {[
                ...
                <div className={`${landingPageStyles.featureIconContainer} ${feature.gradient}`}> {feature.icon}
                </div>
